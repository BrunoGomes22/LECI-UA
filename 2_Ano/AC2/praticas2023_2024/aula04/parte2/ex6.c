...
static int display7Scodes[16] = {0x3F, 0x06, 0x5B, 0x4F, 
                                 0x66, 0x6D, 0x7D, 0x07, 
                                 0x7F, 0x6F, 0x77, 0x7C, 
                                 0x39, 0x5E, 0x79, 0x71};
...
int main(void){
    ...
    TRISB = TRISB | 0x000F; // 0000_0000_0000_1111
    //configure ports RB8 to RB14 as outputs
    TRISB = TRISB & 0x80FF; // 1000_0000_1111_1111
    //configure ports RD5 to RD6 as outputs
    TRISD = TRISD & 0xFF9F; // 1111_1111_1001_1111
    // main loop
    side = 1; // change displays
    while(inkey() != 'q'){
