...
public class PesadoPassEletrico extends PesadoPassageiros implements VeiculoEletrico{
    ...
    public PesadoPassEletrico(String matricula, String marca, String modelo, double potencia, int numeroQuadro, double peso, int numMaxPassageiros, int autonomia){
