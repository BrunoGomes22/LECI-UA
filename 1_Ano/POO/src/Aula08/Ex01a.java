...
public class Ex01a {
    public static void main(String[] args) {
        ...
        viaturas.add(new Taxi("41-AS-12", "Mercedez", "Classe S", 1500, 4, 1500, 123));
        viaturas.add(new Ligeiro("12-AS-32", "Lamborghini", "Gallardo", 1500, 3, 550));
        viaturas.add(new PesadoMercadorias("14-GS-23", "Lancia", "lento", 550, 2, 20000, 40000));
        viaturas.add(new PesadoPassageiros("20-QW-12", "Volvo", "pesadissimo", 132312, 3, 5000, 32));
        int maxKm = 0;
