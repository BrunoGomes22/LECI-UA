...
-- Equation(s):
-- \decOut_n~0_combout\ = (\binInput[2]~input_o\ & (!\binInput[1]~input_o\ & (\binInput[0]~input_o\ $ (!\binInput[3]~input_o\)))) # (!\binInput[2]~input_o\ & (\binInput[0]~input_o\ & (\binInput[1]~input_o\ $ (!\binInput[3]~input_o\))))
...
-- Equation(s):
-- \decOut_n~2_combout\ = (\binInput[2]~input_o\ & (\binInput[3]~input_o\ & ((\binInput[1]~input_o\) # (!\binInput[0]~input_o\)))) # (!\binInput[2]~input_o\ & (!\binInput[0]~input_o\ & (\binInput[1]~input_o\ & !\binInput[3]~input_o\)))
