...
-- Equation(s):
-- \divisor|LessThan0~2_combout\ = (((!\divisor|s_divCounter\(14)) # (!\divisor|s_divCounter\(15))) # (!\divisor|s_divCounter\(13))) # (!\divisor|s_divCounter\(12))
...
-- Equation(s):
-- \divisor|LessThan0~3_combout\ = (!\divisor|s_divCounter\(24) & (!\divisor|s_divCounter\(18) & (!\divisor|s_divCounter\(16) & \divisor|LessThan0~2_combout\)))
...
-- Equation(s):
-- \divisor|clkOut~2_combout\ = (\divisor|s_divCounter\(12) & (\divisor|s_divCounter\(14) & (\divisor|s_divCounter\(13) & !\divisor|s_divCounter\(6))))
...
-- Equation(s):
-- \divisor|clkOut~7_combout\ = (\divisor|clkOut~4_combout\ & (\divisor|s_divCounter\(11) & (\divisor|clkOut~3_combout\ & \divisor|clkOut~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \divisor|clkOut~4_combout\,
	datab => \divisor|s_divCounter\(11),
