...
-- Equation(s):
-- \bit2|cout~0_combout\ = (\b[2]~input_o\ & ((\a[2]~input_o\) # (\bit1|cout~0_combout\))) # (!\b[2]~input_o\ & (\a[2]~input_o\ & \bit1|cout~0_combout\))
...
-- Equation(s):
-- \bit3|cout~0_combout\ = (\b[3]~input_o\ & ((\a[3]~input_o\) # (\bit2|cout~0_combout\))) # (!\b[3]~input_o\ & (\a[3]~input_o\ & \bit2|cout~0_combout\))
...
-- Equation(s):
-- \bit2|s~combout\ = \b[2]~input_o\ $ (\a[2]~input_o\ $ (\bit1|cout~0_combout\))
...
-- Equation(s):
-- \bit3|s~combout\ = \b[3]~input_o\ $ (\a[3]~input_o\ $ (\bit2|cout~0_combout\))
