...
-- Design Ports Information
-- r[0]	=>  Location: PIN_D8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[1]	=>  Location: PIN_F10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[2]	=>  Location: PIN_B8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- r[3]	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- m[2]	=>  Location: PIN_G10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- m[3]	=>  Location: PIN_A7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- op[1]	=>  Location: PIN_G12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- op[0]	=>  Location: PIN_J10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- op[2]	=>  Location: PIN_B7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
PORT MAP (
	...
	datad => \Mod0|auto_generated|divider|divider|StageOut[5]~1_combout\,
...
-- Equation(s):
-- \m~8_combout\ = (!\op[0]~input_o\ & (\op[1]~input_o\ & (\Mult0|auto_generated|op_3~8_combout\ & !\op[2]~input_o\)))
...
-- Equation(s):
-- \Mult0|auto_generated|le4a\(3) = LCELL((\Mult0|auto_generated|cs2a[1]~0_combout\ & (\a[3]~input_o\ $ ((\Mult0|auto_generated|le4a\(5))))) # (!\Mult0|auto_generated|cs2a[1]~0_combout\ & (((\Mult0|auto_generated|le4a\(5) & !\a[2]~input_o\)))))
...
-- Equation(s):
-- \m~9_combout\ = (\Mult0|auto_generated|op_3~10_combout\ & (!\op[2]~input_o\ & (\op[1]~input_o\ & !\op[0]~input_o\)))
...
-- Equation(s):
-- \m~10_combout\ = (!\op[0]~input_o\ & (\op[1]~input_o\ & (\Mult0|auto_generated|op_3~12_combout\ & !\op[2]~input_o\)))
...
-- Equation(s):
-- \m~11_combout\ = (!\op[0]~input_o\ & (\op[1]~input_o\ & (\Mult0|auto_generated|op_3~14_combout\ & !\op[2]~input_o\)))
