...
public class Fraction implements Comparable<Fraction>
{
  ...
  public Fraction divide(Fraction b) {
   assert b.num != 0;
    Fraction q = new Fraction(this.num * b.den, this.den * b.num);    
    
   assert q.multiply(b).equals(this);
   return q;
  ...
  public Fraction subtract(Fraction b) {
    ...
    assert s.add(b).equals(this);
    return s;
  }

  public boolean equals(Fraction b) {
    double resultado1 = (double)b.num / b .den;
    double resultado2 = (double)this.num / this .den;
