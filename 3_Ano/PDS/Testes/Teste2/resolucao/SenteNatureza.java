...
public class SenteNatureza {
	...
	private static void test(PrintStream out) {
		...
		p1.add(new Transporte("Serviço de transporte", "Deslocação entre atividades",
				40));
		...
		p2.add(new Transporte("Serviço de transporte", "Deslocação entre atividades",
				20));
	...
	private static void alineaD(PrintStream out) {
		out.println("\nAlínea d) ----------------------------------\n");
		Subscriber operationsRegister = new OperationsRegister();
		CatalogAdmin ctgAdmin = new BaseCatalogAdmin();
		ctgAdmin.subscribe(operationsRegister);
		CatalogAdmin ctgAdmin2 = new BaseCatalogAdmin();
		ctgAdmin2.subscribe(operationsRegister);

		ctgAdmin.registarServico("1001", new Alojamento("Camping Serr&Sol - Tenda 1", "Local para tenda, 2 m2", 40, 1));
		ctgAdmin.registarServico("1002", new Alojamento("Camping Serr&Sol - Tenda 2", "Local para tenda, 3 m2", 50, 2));
		ctgAdmin.registarServico("1003", new Alojamento("Camping Serr&Sol - Tenda 3", "Local para tenda, 5 m2", 70, 3));
		ctgAdmin.registarServico("1004", new Alojamento("Camping Serr&Sol - Bungalow 1", "Bungalow T0", 90, 2));
		ctgAdmin2.registarServico("2001",
				new Passeio("Lousã a cavalo", "Passeio a cavalo pelas aldeias de xisto", 100));
		ctgAdmin2.registarServico("2002", new Passeio("Lousã TT", "Passeio na serra em 4x4", 320));
		ctgAdmin2.registarServico("3001", new Aventura("Escalada", "Escalada em Góis", 80));
		ctgAdmin2.registarServico("3002", new Aventura("Descida do rio", "Descida em kayak", 100));
		ctgAdmin2.registarServico("3003",
				new Aventura("Canyoning Ribeira da Pena", "Descida a pé da Ribeira da Pena", 80));
	}
