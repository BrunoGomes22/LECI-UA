...
public class TestPart2 {
    public static void main(String[] args) {
        ...
        Iterator<StudentAdm> leiStudentsIterator = gs.iterator(Course.LEI);
        while (leiStudentsIterator.hasNext()) {
            System.out.println(leiStudentsIterator.next());
        }
...
/*
 * Expected Output:
 * LEI director reports that student John (98765) has changed the overall grade:
 * 17.0
 * Professor Mary of Programming class evaluated student John (98765) with
 * score: 17.0
 * LEI director reports that student John (98765) has changed the overall grade:
 * 16.5
 * Professor Mary of Programming class evaluated student John (98765) with
 ...
 * LECI director reports that student George (65432) has changed the overall
 * grade: 15.0
 * Professor Ana of Project class evaluated student George (65432) with score:
 * 15.0
 * LEI director reports that student Mary (102345) has changed the overall
 * grade: 16.0
 * Professor Mario of POO class evaluated student Mary (102345) with score: 16.0
 * LEEC director reports that student Peter (101023) has changed the overall
 * grade: 12.0
 * Professor Xavier of Digital Eletronics class evaluated student Peter (101023)
 * with score: 12.0
 * LEEC director reports that student Peter (101023) has changed the overall
 * grade: 13.0
 * Professor Xavier of Digital Eletronics class evaluated student Peter (101023)
 * with score: 12.0
 * Professor Paula of Mathematics class evaluated student Peter (101023) with
 * score: 14.0
 * 
