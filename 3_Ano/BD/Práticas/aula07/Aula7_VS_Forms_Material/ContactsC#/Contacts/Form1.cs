...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= LAPTOP-A6Q32042\\SQLEXPRESS;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void SubmitContact(Contact C)
        {
            ...
            //meter parametros para adicionar fax e tel
            cmd.Connection = cn;
