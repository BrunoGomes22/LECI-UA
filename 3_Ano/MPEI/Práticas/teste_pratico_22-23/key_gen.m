function chaves = key_gen(N, caracteres, prob)
    ...
    for i = 1:N % probabilidade de 40% da palavra ter 5 carateres OU 60% ter 8 carateres
        comprimento =8;
        p = rand(1); % valor aleatorio entre 0 e 1
        if p < 0.4
            comprimento = 5;
        end
